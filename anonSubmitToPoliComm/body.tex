...
spectacle and competitive framing continues; for instance, political campaigns are often portrayed as
military campaigns (see~\cite{Burnes2011,Kalmoe2014}). In the U.S. and
...
(see~\cite{Matlock2013}) or battles (see~\cite{Flusberg2018}). Importantly, using
metaphorical violence in political discourse has real consequences on
reasoning; for instance, it can increase the tendency to polarize
(see~\cite{Kalmoe2018}).
...
approach we have outlined here (see also~\citeA{Fusaroli2015}). To understand the
...
violence to identify correlations (as in~\citeA{Kalmoe2014}). 
